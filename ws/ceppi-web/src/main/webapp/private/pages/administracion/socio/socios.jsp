	            ...
	            <div class="panel panel-default" id="toolbar-showcase">
	                        	...
	                        	<div class="panel-toolbar">
	                                <div class="input-group">
	                                    ...
	                                    <div class="input-group-btn">
	                                    	<a href="#/administracion/socios/crear" class="btn btn-default">Nuevo</a>	                                        	                                       
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
	                ...
	                <div class="panel-collapse pull out">
	                    <table class="table table-bordered table-hover">
	                        ...
	                        <tbody>	                            
	                            <tr ng-repeat="p in socios | filter:q as results">	                                                               
	                                    <td>{{p.oid}}</td>
	                                    <td>{{p.persona.nombre}}&nbsp;{{p.persona.apellidoPaterno}}</td>
	                                    <td>{{p.categoriaSocio.nombre}}</td>
	                                    <td>{{p.tipoSocio.nombre}}</td>
	                                        ...
	                                        <div class="toolbar">
	                                            <div class="btn-group">
	                                                ...
	                                                <ul class="dropdown-menu dropdown-menu-right">	                                                    
	                                                    <li><a href="#/administracion/socios/editar/{{p.oid}}"><i class="icon ico-pencil"></i>Editar</a></li>
	                                                    <li class="divider"></li>
