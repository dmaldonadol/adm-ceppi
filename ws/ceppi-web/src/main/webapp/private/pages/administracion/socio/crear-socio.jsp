		        				...
		        				<form class="form-horizontal form-bordered" id="form-create-person">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-5">
	                                        ...
	                                        data-parsley-error-message="Por favor ingrese rut" data-parsley-required maxlength="8" ng-disabled="continuar">
	                                    </div>
	                                    <div class="col-sm-2">
	                                        <input type="text" class="form-control" ng-model="socio.persona.dv" placeholder="dv"
	                                        data-parsley-error-message="Por favor ingrese dv" data-parsley-required maxlength="1" ng-disabled="continuar">
	                                    </div>
	                                    <div class="col-sm-1">
					        				<button class="btn btn-success"  value="button"  ng-click="buscarSocio(socio.persona.rut)"><i class="ico-search"></i></button>
					        				
					        			</div>
					        			<div class="col-sm-8" style="padding: 10px 0px 0px 100px;" ng-show="socioExiste">
