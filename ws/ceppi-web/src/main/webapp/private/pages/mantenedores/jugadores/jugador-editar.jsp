    ...
    <div class="container-fluid">
        <div class="page-header page-header-block">
            <div class="page-header-section">
                <h4 class="title semibold">Editar Jugador</h4>
            </div>
            <div class="page-header-section">
                <div class="toolbar">
       		...
       		<div class="col-md-12">
	    		<div class="panel panel-default" id="toolbar-showcase">
	                <div class="panel-heading">
	                    <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-plus"></i></span>Editar Jugador</h3>
	                </div>
	               <div class="panel-body panel-collapse pull out">
	               		<div class="row">
	               			<form class="form-horizontal form-bordered" action="" id="form-editar-jugador">
	               			<div class="col-md-6">
