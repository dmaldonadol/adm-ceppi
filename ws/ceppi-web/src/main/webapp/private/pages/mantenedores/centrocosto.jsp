    ...
    <div class="container-fluid">
        <div class="page-header page-header-block">
            <div class="page-header-section">
                <h4 class="title semibold">Centro de Costo</h4>
            </div>
            <div class="page-header-section">
                <div class="toolbar">
	        ...
	        <div class="col-md-12">
	            <div class="panel panel-default" id="toolbar-showcase">
	                <div class="panel-heading">
	                    <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-equalizer"></i></span> Centro de Costo</h3>
	                ...
	                <div class="panel-collapse pull out">
	                    <table class="table table-bordered table-hover">
	                        ...
	                        <tbody>	                            
	                            <tr ng-repeat="c in listaCentroCosto | filter:q as results">	                                                               
	                                    <td>{{c.codigo}}</td>
	                                    <td>{{c.nombre}}</td>
	                                    <td>{{c.descripcion}}</td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header text-center">
                            ...
                            <h3 class="semibold modal-title">Nuevo Centro Costo</h3>
                        </div>
            ...
            <div id="modal-update" class="modal fade" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header text-center">
                            <button type="button" class="close" data-dismiss="modal">×</button>
                            <h3 class="semibold modal-title">Editar Centro Costo</h3>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal form-bordered" action="">
	                            <div class="form-group">
