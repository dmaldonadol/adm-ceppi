    ...
    <div class="container-fluid">
        <div class="page-header page-header-block">
            <div class="page-header-section">
                <h4 class="title semibold">Tipo de Gasto</h4>
            </div>
            <div class="page-header-section">
                <div class="toolbar">
	        ...
	        <div class="col-md-12">
	            <div class="panel panel-default" id="toolbar-showcase">
	                <div class="panel-heading">
	                    <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-equalizer"></i></span>Tipo de Gasto</h3>
	                ...
	                <div class="panel-collapse pull out">
	                    <table class="table table-bordered table-hover">
	                        ...
	                        <tbody>	                            
	                            <tr ng-repeat="g in listaTipoGasto | filter:q as results">	                                                               
	                                    <td>{{g.codigo}}</td>
	                                    <td>{{g.nombre}}</td>
	                                    <td>{{g.descripcion}}</td>
	                                        ...
	                                        <div class="toolbar">
	                                            <div class="btn-group">
	                                                ...
	                                                <ul class="dropdown-menu dropdown-menu-right">
	                                                    <li><a href="javascript:void(0);" ng-click="selecionActualizar( g )"><i class="icon ico-pencil"></i>Editar</a></li>
	                                                    <li class="divider"></li>
	                                                    <li><a href="javascript:void(0);" ng-click="eliminar( g )" class="text-danger"><i class="icon ico-remove3"></i>Eliminar</a></li>
	                                                </ul>
	                                            </div>
	                                        </div>
	                                    </td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header text-center">
                            ...
                            <h3 class="semibold modal-title">Nuevo Tipo Gasto</h3>
                        </div>
            ...
            <div id="modal-update" class="modal fade" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header text-center">
                            <button type="button" class="close" data-dismiss="modal">×</button>
                            <h3 class="semibold modal-title">Editar Tipo Gasto</h3>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal form-bordered" action="">
	                            <div class="form-group">
