...
app.controller("TipoGastoController", function($scope, $http)
{
	...
	$scope.nuevo = function()
	{
		...
		var request = $http.put( CONSTANTS.contextPath + "/api/private/tipo/gasto", objeto );
	...
	{
		console.log( objeto );
		var request = $http.post( CONSTANTS.contextPath + "/api/private/tipo/gasto" , $scope.objUpdate );
		NProgress.configure({ parent: '.modal-body' });
		NProgress.start();
		request.success( function( response )
		{
	...
	{
		var request = $http.delete( CONSTANTS.contextPath + "/api/private/tipo/gasto/"+objeto.oid );
		NProgress.configure({ parent: '#main' });
		NProgress.start();
		request.success( function( response )
		{
